...
public class NewMasterDetailForm extends JPanel {
    ...
    private void initComponents() {
        ...
        query = Beans.isDesignTime() ? null : entityManager.createQuery("SELECT m FROM Mcatagory m");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.shenghui.persistence.entity.Mcatagory> toRemove = new ArrayList<com.shenghui.persistence.entity.Mcatagory>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.shenghui.persistence.entity.Mcatagory m = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(m);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.shenghui.persistence.entity.Mcatagory m = new com.shenghui.persistence.entity.Mcatagory();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.shenghui.persistence.entity.Mcatagory> merged = new ArrayList<com.shenghui.persistence.entity.Mcatagory>(list.size());
            for (com.shenghui.persistence.entity.Mcatagory m : list) {
    ...
    private List<com.shenghui.persistence.entity.Mcatagory> list;
